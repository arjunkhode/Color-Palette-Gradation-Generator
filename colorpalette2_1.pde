/* COLORPALETTE ver 2.1 - some support for recolor has been added
adjust recolor squares number
hardcode the fill of randomness of rectangle
press r to regenerate the random squares
...
int recolor_squares = 20; //how many random squares do you want to recolor? 0 is allowed
// n queens problem
...
void recolor(){
  ...
  */
  ...
  for(int i = 0; i<recolor_squares; i++){
    ...
    fill(color(random(255),random(175,255)-175,random(50,255)-50)); //set fill color of rectangle
